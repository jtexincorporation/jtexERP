...
namespace JTex {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class GroupsDataTable : global::System.Data.TypedTableBase<GroupsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public GroupsRow AddGroupsRow(string Name, int Number) {
...
namespace JTex.DataSet2TableAdapters {
    ...
    public partial class GroupsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [JTex].[dbo].[Groups] WHERE (([GroupID] = ?) AND ([Name] = ?) AND ([N" +
                "umber] = ?))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [JTex].[dbo].[Groups] ([Name], [Number]) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [JTex].[dbo].[Groups] SET [Name] = ?, [Number] = ? WHERE (([GroupID] = ?) " +
                "AND ([Name] = ?) AND ([Number] = ?))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT \"GroupID\", \"Name\", \"Number\" FROM \"dbo\".\"Groups\"";
        ...
        public virtual int Delete(int Original_GroupID, string Original_Name, int Original_Number) {
        ...
        public virtual int Update(string Name, int Number, int Original_GroupID, string Original_Name, int Original_Number) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
