...
namespace JTex {
    ...
    public partial class StoreDataSet : global::System.Data.DataSet {
        ...
        public partial class StoresDataTable : global::System.Data.TypedTableBase<StoresRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StoresRow AddStoresRow(string Name, string Remarks) {
            ...
            public string Remarks {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Remarks\' in table \'Stores\' is DBNull.", e);
                    }
                }
                set {
...
namespace JTex.StoreDataSetTableAdapters {
    ...
    public partial class StoresTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [JTex].[dbo].[Stores] WHERE (([StoreID] = ?) AND ((? = 1 AND [Name] I" +
                "S NULL) OR ([Name] = ?)) AND ((? = 1 AND [Remarks] IS NULL) OR ([Remarks] = ?)))" +
                "";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [JTex].[dbo].[Stores] ([Name], [Remarks]) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [JTex].[dbo].[Stores] SET [Name] = ?, [Remarks] = ? WHERE (([StoreID] = ?)" +
                " AND ((? = 1 AND [Name] IS NULL) OR ([Name] = ?)) AND ((? = 1 AND [Remarks] IS N" +
                "ULL) OR ([Remarks] = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT \"StoreID\", \"Name\", \"Remarks\" FROM \"dbo\".\"Stores\"";
        ...
        public virtual int Fill(StoreDataSet.StoresDataTable dataTable) {
        ...
        public virtual StoreDataSet.StoresDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StoreDataSet.StoresDataTable dataTable = new StoreDataSet.StoresDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StoreDataSet.StoresDataTable dataTable) {
        ...
        public virtual int Delete(int Original_StoreID, string Original_Name, string Original_Remarks) {
        ...
        public virtual int Insert(string Name, string Remarks) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Remarks, int Original_StoreID, string Original_Name, string Original_Remarks) {
            if ((Name == null)) {
