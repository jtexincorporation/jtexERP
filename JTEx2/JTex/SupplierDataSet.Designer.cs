...
namespace JTex {
    ...
    public partial class SupplierDataSet : global::System.Data.DataSet {
        ...
        public partial class SuppliersDataTable : global::System.Data.TypedTableBase<SuppliersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public SuppliersRow AddSuppliersRow(int AccountID, string Name, string Category, string Address, string ContactPerson, string PhoneNumber, string Email) {
...
namespace JTex.SupplierDataSetTableAdapters {
    ...
    public partial class SuppliersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [JTex].[dbo].[Suppliers] WHERE (([SupplierID] = ?) AND ((? = 1 AND [AccountID] IS NULL) OR ([AccountID] = ?)) AND ((? = 1 AND [Name] IS NULL) OR ([Name] = ?)) AND ((? = 1 AND [Category] IS NULL) OR ([Category] = ?)) AND ((? = 1 AND [Address] IS NULL) OR ([Address] = ?)) AND ((? = 1 AND [ContactPerson] IS NULL) OR ([ContactPerson] = ?)) AND ((? = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = ?)) AND ((? = 1 AND [Email] IS NULL) OR ([Email] = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [JTex].[dbo].[Suppliers] ([AccountID], [Name], [Category], [Address]," +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [JTex].[dbo].[Suppliers] SET [AccountID] = ?, [Name] = ?, [Category] = ?, [Address] = ?, [ContactPerson] = ?, [PhoneNumber] = ?, [Email] = ? WHERE (([SupplierID] = ?) AND ((? = 1 AND [AccountID] IS NULL) OR ([AccountID] = ?)) AND ((? = 1 AND [Name] IS NULL) OR ([Name] = ?)) AND ((? = 1 AND [Category] IS NULL) OR ([Category] = ?)) AND ((? = 1 AND [Address] IS NULL) OR ([Address] = ?)) AND ((? = 1 AND [ContactPerson] IS NULL) OR ([ContactPerson] = ?)) AND ((? = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = ?)) AND ((? = 1 AND [Email] IS NULL) OR ([Email] = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT \"SupplierID\", \"AccountID\", \"Name\", \"Category\", \"Address\", \"ContactPerson\"," +
                " \"PhoneNumber\", \"Email\" FROM \"dbo\".\"Suppliers\"";
        ...
        public virtual int Fill(SupplierDataSet.SuppliersDataTable dataTable) {
        ...
        public virtual SupplierDataSet.SuppliersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SupplierDataSet.SuppliersDataTable dataTable = new SupplierDataSet.SuppliersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SupplierDataSet.SuppliersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_SupplierID, global::System.Nullable<int> Original_AccountID, string Original_Name, string Original_Category, string Original_Address, string Original_ContactPerson, string Original_PhoneNumber, string Original_Email) {
