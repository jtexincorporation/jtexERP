...
namespace JTex {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CustomersRow AddCustomersRow(int AccountID, string Name, string Category, string Address, string ContactPerson, string PhoneNumber, string Email) {
...
namespace JTex.CustomerDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [JTex].[dbo].[Customers] WHERE (([CustomerID] = ?) AND ((? = 1 AND [AccountID] IS NULL) OR ([AccountID] = ?)) AND ((? = 1 AND [Name] IS NULL) OR ([Name] = ?)) AND ((? = 1 AND [Category] IS NULL) OR ([Category] = ?)) AND ((? = 1 AND [Address] IS NULL) OR ([Address] = ?)) AND ((? = 1 AND [ContactPerson] IS NULL) OR ([ContactPerson] = ?)) AND ((? = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = ?)) AND ((? = 1 AND [Email] IS NULL) OR ([Email] = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [JTex].[dbo].[Customers] ([AccountID], [Name], [Category], [Address]," +
                " [ContactPerson], [PhoneNumber], [Email]) VALUES (?, ?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [JTex].[dbo].[Customers] SET [AccountID] = ?, [Name] = ?, [Category] = ?, [Address] = ?, [ContactPerson] = ?, [PhoneNumber] = ?, [Email] = ? WHERE (([CustomerID] = ?) AND ((? = 1 AND [AccountID] IS NULL) OR ([AccountID] = ?)) AND ((? = 1 AND [Name] IS NULL) OR ([Name] = ?)) AND ((? = 1 AND [Category] IS NULL) OR ([Category] = ?)) AND ((? = 1 AND [Address] IS NULL) OR ([Address] = ?)) AND ((? = 1 AND [ContactPerson] IS NULL) OR ([ContactPerson] = ?)) AND ((? = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = ?)) AND ((? = 1 AND [Email] IS NULL) OR ([Email] = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT \"CustomerID\", \"AccountID\", \"Name\", \"Category\", \"Address\", \"ContactPerson\"," +
                " \"PhoneNumber\", \"Email\" FROM \"dbo\".\"Customers\"";
        ...
        public virtual int Delete(int Original_CustomerID, global::System.Nullable<int> Original_AccountID, string Original_Name, string Original_Category, string Original_Address, string Original_ContactPerson, string Original_PhoneNumber, string Original_Email) {
            ...
            if ((Original_ContactPerson == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((string)(Original_ContactPerson));
            }
        ...
        public virtual int Insert(global::System.Nullable<int> AccountID, string Name, string Category, string Address, string ContactPerson, string PhoneNumber, string Email) {
        ...
        public virtual int Update(global::System.Nullable<int> AccountID, string Name, string Category, string Address, string ContactPerson, string PhoneNumber, string Email, int Original_CustomerID, global::System.Nullable<int> Original_AccountID, string Original_Name, string Original_Category, string Original_Address, string Original_ContactPerson, string Original_PhoneNumber, string Original_Email) {
            if ((AccountID.HasValue == true)) {
